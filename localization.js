const translations = {
    "en": {
        ...
        "story_title": "Story",
        "story_text": "You found an ancient telescope that can reveal forgotten constellations. To look through it, you'll need to align the lenses using Light Shards — which you collect by solving logic puzzles. Explore 80 star systems and take on a new Daily Challenge every day.",
        "rules_title": "Rules",
        ...
        "meta_description": "Solve star logic puzzles, reveal 80 hidden constellations, and play offline at your own pace. A new Daily Challenge awaits every day."
    },
    "ru": {
        "hero_title": "ASTRONIGMA",
        ...
        "story_title": "История",
        "story_text": "Вы нашли древний телескоп, способный открыть забытые созвездия. Чтобы заглянуть в него, нужно настроить линзы с помощью Осколков света, которые вы собираете, решая логические загадки. Исследуйте 80 звёздных систем и каждый день выполняйте новое Ежедневное задание.",
        "rules_title": "Правила",
        ...
        "meta_description": "Решайте логические загадки о звёздах, открывайте 80 созвездий и играйте офлайн. Новое Ежедневное задание ждёт вас каждый день."
    },
    "sr": {
        "hero_title": "ASTRONIGMA",
        ...
        "story_title": "Priča",
        "story_text": "Pronašli ste drevni teleskop koji može otkriti zaboravljena sazvežđa. Da biste gledali kroz njega, morate podesiti sočiva koristeći Oskolke svetla — koje sakupljate rešavanjem logičkih zagonetki. Istražite 80 zvezdanih sistema i suočite se s novim Dnevnim izazovom svaki dan.",
        "rules_title": "Pravila",
        ...
        "meta_description": "Rešavajte logičke zagonetke, otkrijte 80 sazvežđa i igrajte offline. Novi Dnevni izazov čeka vas svaki dan."
    },
    "es": {
        "hero_title": "ASTRONIGMA",
        ...
        "story_text": "Has encontrado un antiguo telescopio que puede revelar constelaciones olvidadas. Para mirar a través de él, debes ajustar las lentes usando Fragmentos de luz, que obtienes resolviendo acertijos lógicos. Explora 80 sistemas estelares y supera un nuevo Desafío Diario cada día.",
        "rules_title": "Reglas",
        ...
        "meta_description": "Resuelve puzzles lógicos, descubre 80 constelaciones y juega sin conexión. Un nuevo Desafío Diario te espera cada día."
    },
    "pt": {
        "hero_title": "ASTRONIGMA",
        ...
        "story_text": "Você encontrou um antigo telescópio capaz de revelar constelações esquecidas. Para olhar através dele, você deve ajustar as lentes usando Fragmentos de luz — que você coleta resolvendo quebra-cabeças lógicos. Explore 80 sistemas estelares e enfrente um novo Desafio Diário a cada dia.",
        "rules_title": "Regras",
        ...
        "meta_description": "Resolva puzzles lógicos, revele 80 constelações e jogue offline no seu ritmo. Um novo Desafio Diário espera você a cada dia."
    },
    "de": {
        "hero_title": "ASTRONIGMA",
        ...
        "story_text": "Du hast ein uraltes Teleskop gefunden, das vergessene Sternbilder enthüllen kann. Um hindurchzusehen, musst du die Linsen mit Lichtfragmenten justieren — die du durch das Lösen logischer Rätsel sammelst. Entdecke 80 Sternensysteme und stelle dich jeden Tag einer neuen Täglichen Herausforderung.",
        "rules_title": "Regeln",
        ...
        "meta_description": "Löse Sternen-Logikrätsel, entdecke 80 Sternbilder und spiele offline. Jeden Tag wartet eine neue Tägliche Herausforderung auf dich."
    },
    "fr": {
        "hero_title": "ASTRONIGMA",
        ...
        "story_text": "Vous avez trouvé un ancien télescope capable de révéler des constellations oubliées. Pour regarder à travers, vous devez ajuster les lentilles en utilisant des Fragments de lumière — que vous collectez en résolvant des énigmes logiques. Explorez 80 systèmes stellaires et relevez un nouveau Défi quotidien chaque jour.",
        "rules_title": "Règles",
        ...
        "meta_description": "Résolvez des énigmes logiques, révélez 80 constellations et jouez hors ligne. Un nouveau Défi quotidien vous attend chaque jour."
    },
    "ja": {
        "hero_title": "ASTRONIGMA",
        ...
        "story_title": "ストーリー",
        "story_text": "あなたは忘れられた星座を映し出す古代の望遠鏡を見つけました。それを覗くには、論理パズルを解いて集めた「光のかけら」を使ってレンズを調整する必要があります。80の星系を探索し、毎日新しいデイリーチャレンジに挑戦しましょう。",
        "rules_title": "ルール",
        ...
        "meta_description": "星の論理パズルを解き、80の星座を発見しよう。毎日新しいデイリーチャレンジが登場。オフラインで自分のペースに楽しめます。"
    },
    "ko": {
        "hero_title": "ASTRONIGMA",
        ...
        "story_title": "스토리",
        "story_text": "당신은 잊혀진 별자리를 드러낼 수 있는 고대의 망원경을 발견했습니다. 그곳을 들여다보려면 논리 퍼즐을 풀어 모은 '빛의 파편'을 사용하여 렌즈를 조정해야 합니다. 80개의 별 시스템을 탐험하고 매일 새로운 데일리 챌린지에 도전해 보세요.",
        "rules_title": "규칙",
        ...
        "meta_description": "별 논리 퍼즐을 풀고 80개의 별자리를 발견하세요. 매일 새 데일리 챌린지, 완전 오프라인으로 부담 없이 즐길 수 있습니다."
    },
    "tr": {
        "hero_title": "ASTRONIGMA",
        ...
        "story_title": "Hikaye",
        "story_text": "Unutulmuş takımyıldızları ortaya çıkarabilen kadim bir teleskop buldun. İçinden bakmak için, mantık bulmacalarını çözerek topladığın Işık parçalarını kullanarak mercekleri ayarlamalısın. 80 yıldız sistemini keşfet ve her gün yeni bir Günlük Meydan Okuma ile yüzleş.",
        ...
        "meta_description": "Yıldız mantık bulmacalarını çöz, 80 takımyıldızını keşfet ve çevrimdışı oyna. Her gün yeni bir Günlük Meydan Okuma seni bekliyor."
    },
    "th": {
        "hero_title": "ASTRONIGMA",
        ...
        "story_text": "คุณได้พบกล้องโทรทรรศน์โบราณที่สามารถเผยกลุ่มดาวที่ถูกลืม เพื่อที่จะมองผ่านมัน คุณต้องปรับเลนส์โดยใช้ 'เศษแสง' ซึ่งคุณรวบรวมได้จากการแก้ปริศนาตรรกะ สำรวจ 80 ระบบดาวและรับความท้าทายรายวันใหม่ทุกวัน",
        "rules_title": "กฎกติกา",
        ...
        "meta_description": "แก้ปริศนาตรรกะ ค้นพบ 80 กลุ่มดาว และเล่นออฟไลน์ได้ตามจังหวะของคุณ ความท้าทายรายวันใหม่รอทุกวัน"
    },
    "id": {
        "hero_title": "ASTRONIGMA",
        ...
        "story_title": "Cerita",
        "story_text": "Anda menemukan teleskop kuno yang dapat mengungkap rasi bintang yang terlupakan. Untuk melihat melaluinya, Anda harus menyesuaikan lensa menggunakan Pecahan cahaya — yang Anda kumpulkan dengan memecahkan teka-teki logika. Jelajahi 80 sistem bintang dan hadapi Tantangan Harian baru setiap hari.",
        "rules_title": "Aturan",
        ...
        "meta_description": "Selesaikan teka-teki logika, temukan 80 rasi bintang, dan main offline santai. Tantangan Harian baru menanti setiap hari."
    },
    "zh": {
        "hero_title": "ASTRONIGMA",
        ...
        "story_title": "故事",
        "story_text": "你发现了一架能够揭示被遗忘星座的古老望远镜。为了通过它观察，你需要使用光之碎片来调整镜片——这些碎片是你通过解开逻辑谜题收集到的。探索80个恒星系统，每天迎接新的每日挑战。",
        "rules_title": "规则",
        ...
        "meta_description": "解开星空逻辑谜题，发现80个隐藏星座，离线畅玩。每天迎接全新每日挑战，探索宇宙奥秘。"
    }
};
